            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap gap-4">
                <div className="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-full backdrop-blur-sm">
                  <Shield className="h-5 w-5 text-[#BFCC2E]" />
                  <span className="text-sm font-semibold">Validade Legal</span>
                </div>
                <div className="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-full backdrop-blur-sm">
                  <Stamp className="h-5 w-5 text-[#BFCC2E]" />
                  <span className="text-sm font-semibold">Certificado em Cartório</span>
                </div>
                <div className="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-full backdrop-blur-sm">
                  <Globe className="h-5 w-5 text-[#BFCC2E]" />
                  <span className="text-sm font-semibold">Reconhecimento Internacional</span>
                </div>
              </div>
            ...
            {documentTypes.map((type, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-lg font-bold text-[#4F6A8B] mb-4">{type.title}</h3>
              ...
              {steps.map((step, index) => (
                <div key={index} className="relative">
                  <div className="text-center">
                    <div className="bg-gradient-to-br from-[#4F6A8B] to-[#3d5570] w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-xl">
                      <span className="text-3xl font-bold text-white">{step.number}</span>
                    </div>
                    <h3 className="text-lg font-bold text-[#4F6A8B] mb-2">{step.title}</h3>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4 p-4 rounded-xl hover:bg-gradient-to-r hover:from-[#4F6A8B]/5 hover:to-[#BFCC2E]/5 transition-all">
                    ...
                    <div>
                      <h3 className="font-bold text-[#4F6A8B] mb-1">Validade Legal Garantida</h3>
                      <p className="text-gray-600">
                        Traduções com fé pública, reconhecidas por todos os órgãos oficiais
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-4 rounded-xl hover:bg-gradient-to-r hover:from-[#4F6A8B]/5 hover:to-[#BFCC2E]/5 transition-all">
                    ...
                    <div>
                      <h3 className="font-bold text-[#4F6A8B] mb-1">Certificação em Cartório</h3>
                      <p className="text-gray-600">
                        Todos os documentos são registrados e certificados conforme legislação
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-4 rounded-xl hover:bg-gradient-to-r hover:from-[#4F6A8B]/5 hover:to-[#BFCC2E]/5 transition-all">
                    ...
                    <div>
                      <h3 className="font-bold text-[#4F6A8B] mb-1">
                        Reconhecimento Internacional
                      </h3>
                      <p className="text-gray-600">
                        Documentos aceitos em embaixadas, consulados e órgãos estrangeiros
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-4 rounded-xl hover:bg-gradient-to-r hover:from-[#4F6A8B]/5 hover:to-[#BFCC2E]/5 transition-all">
                    ...
                    <div>
                      <h3 className="font-bold text-[#4F6A8B] mb-1">Prazo Garantido</h3>
                      <p className="text-gray-600">
                        Comprometimento total com os prazos acordados, sem atrasos
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="bg-gradient-to-br from-[#4F6A8B] to-[#3d5570] p-8 rounded-2xl text-white text-center shadow-xl">
                  <Clock className="h-14 w-14 mx-auto mb-4 text-[#BFCC2E]" />
                  <div className="text-4xl font-bold mb-2">3-5</div>
                  <p className="text-gray-300">Dias úteis</p>
                </div>

                <div className="bg-gradient-to-br from-[#BFCC2E] to-[#a8b41f] p-8 rounded-2xl text-black text-center shadow-xl">
                  <Shield className="h-14 w-14 mx-auto mb-4" />
                  <div className="text-4xl font-bold mb-2">100%</div>
                  <p className="text-gray-700">Legal</p>
                </div>

                <div className="bg-gradient-to-br from-[#BFCC2E] to-[#a8b41f] p-8 rounded-2xl text-black text-center shadow-xl">
                  <Stamp className="h-14 w-14 mx-auto mb-4" />
                  <div className="text-4xl font-bold mb-2">Selo</div>
                  <p className="text-gray-700">Oficial</p>
                </div>

                <div className="bg-gradient-to-br from-[#4F6A8B] to-[#3d5570] p-8 rounded-2xl text-white text-center shadow-xl">
                  <Globe className="h-14 w-14 mx-auto mb-4 text-[#BFCC2E]" />
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {faqs.map((faq, index) => (
              ...
              >
                <h3 className="text-lg font-bold text-[#4F6A8B] mb-2">{faq.q}</h3>
